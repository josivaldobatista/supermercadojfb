package com.jfb.cursomc.api.resources.exceptions;
...
import com.jfb.cursomc.api.services.exceptions.FileException;
...
public class ResourceExceptionHandler {
    ...
    public ResponseEntity<StandardError> amazonService(AmazonServiceException e, HttpServletRequest request) {  
        HttpStatus code = HttpStatus.valueOf(e.getErrorCode()); // Pega o código que veio na exceção e transforma em HttpStatus.
